class ContaBancaria:
    ...
    def informacoes_da_conta(self):
        return f"Titular: {self.titular}, Número da Conta: {self._numero_conta}, Saldo: R${self.__saldo:.2f}"

# Criando e usando a conta bancária
conta = ContaBancaria("Alice", "001122")
conta.depositar(300) # Não seria possível acrescentar o valor diretamento no 'saldo'
conta.sacar(150)
